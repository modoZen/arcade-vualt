...
const SKIN_KEY = "av_serpiente_skin";
const SKIN_OPTIONS: { value: SerpienteSkin; label: string }[] = [
...
export default function SerpientePlayerPage() {
  const { user } = useAuth();
  ...
  const [skin, setSkin] = useState<SerpienteSkin>(() => {
    if (typeof window === "undefined") return "retro";
    return (localStorage.getItem(SKIN_KEY) as SerpienteSkin) ?? "retro";
  });

  const changeSkin = (value: SerpienteSkin) => {
    setSkin(value);
      ...
      <div className="player-hud">
        ...
        <div className="hud-actions">
          <select
            ...
            value={skin}
            onChange={(e) => changeSkin(e.target.value as SerpienteSkin)}
            aria-label="Skin de la serpiente"
          >
